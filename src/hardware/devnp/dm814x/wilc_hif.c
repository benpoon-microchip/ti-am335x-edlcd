...
int32_t handle_scan_done(struct wilc_vif *vif, enum scan_event evt)
{
	...
	if (evt == SCAN_EVENT_DONE) {
		...
		wid.type = WID_CHAR;
		wid.val = (int8_t *)&abort_running_scan;
...
void set_bss_param_asus(struct wilc_join_bss_param *bss_param)
{
	bss_param->ssid_terminator  = 0;
	bss_param->bss_type = 0;
	bss_param->ch = 0x5;
	bss_param->cap_info = 0x421;
	bss_param->sa[0] = 0x0; bss_param->sa[1] = 0x0; bss_param->sa[2] = 0x0; bss_param->sa[3] = 0x0; bss_param->sa[4] = 0x0; bss_param->sa[5] = 0x0;
	bss_param->bssid[0] = 0x10; bss_param->bssid[1] = 0x7b; bss_param->bssid[2] = 0x44; bss_param->bssid[3] = 0xea; bss_param->bssid[4] = 0x1c; bss_param->bssid[5] = 0xa8;
	bss_param->beacon_period = 0x64;
	bss_param->dtim_period = 0x0;
	bss_param->supp_rates[0] = 0xc; bss_param->supp_rates[1] = 0x82; bss_param->supp_rates[2] = 0x84; bss_param->supp_rates[3] = 0x8b ; bss_param->supp_rates[4] = 0x96;
	bss_param->supp_rates[5] = 0xc; bss_param->supp_rates[6] = 0x12; bss_param->supp_rates[7] = 0x18; bss_param->supp_rates[8] = 0x24; bss_param->supp_rates[9] = 0x30;
	bss_param->supp_rates[10] = 0x48; bss_param->supp_rates[11] = 0x60; bss_param->supp_rates[12] = 0x6c;
	bss_param->wmm_cap = 0x1;
	bss_param->uapsd_cap = 0x1;
	bss_param->ht_capable = 0x1;
	bss_param->rsn_found = 0x0;
	bss_param->rsn_grp_policy = 0x0;
	bss_param->mode_802_11i = 0x0;
	bss_param->p_suites[0] = 0xff; bss_param->p_suites[1] = 0xff; bss_param->p_suites[2] = 0xff;
	bss_param->akm_suites[0] = 0xff; bss_param->akm_suites[1] = 0xff; bss_param->akm_suites[2] = 0xff;
	bss_param->rsn_cap[0] = 0x0; bss_param->rsn_cap[1] = 0x0;
	bss_param->noa_enabled = 0x0;
	bss_param->tsf_lo = 0x0;
	bss_param->idx = 0x0;
	bss_param->opp_enabled = 0x0;
	bss_param->opp_dis.cnt = 0x0;
	bss_param->opp_dis.duration = 0x0;
	bss_param->opp_dis.interval = 0x0;
	bss_param->opp_dis.start_time = 0x0;

}
void set_bss_param_ver2(struct wilc_join_bss_param *bss_param)
{
	memcpy(bss_param->ssid, "mchp_demo", 9);
	bss_param->ssid_terminator  = 0;
	bss_param->bss_type = 0;
	bss_param->ch = 0x2;
	bss_param->cap_info = 0xb;
	bss_param->sa[0] = 0x0; bss_param->sa[1] = 0x0; bss_param->sa[2] = 0x0; bss_param->sa[3] = 0x0; bss_param->sa[4] = 0x0; bss_param->sa[5] = 0x0;
	bss_param->bssid[0] = 0x50; bss_param->bssid[1] = 0xc7; bss_param->bssid[2] = 0xbf; bss_param->bssid[3] = 0xae; bss_param->bssid[4] = 0xe1; bss_param->bssid[5] = 0x7a;
	bss_param->beacon_period = 0x64;
	bss_param->dtim_period = 0x0;
	bss_param->supp_rates[0] = 0xc; bss_param->supp_rates[1] = 0x82; bss_param->supp_rates[2] = 0x84; bss_param->supp_rates[3] = 0x8b ; bss_param->supp_rates[4] = 0x96;
	bss_param->supp_rates[5] = 0xc; bss_param->supp_rates[6] = 0x12; bss_param->supp_rates[7] = 0x18; bss_param->supp_rates[8] = 0x24; bss_param->supp_rates[9] = 0x30;
...
void set_bss_param_linksys(struct wilc_join_bss_param *bss_param)
{
	memcpy(bss_param->ssid, "MCHP_AP", 7);
	bss_param->ssid_terminator  = 0;
	bss_param->bss_type = 0;
	bss_param->ch = 0x7;
	bss_param->cap_info = 0x401;
	bss_param->sa[0] = 0x0; bss_param->sa[1] = 0x0; bss_param->sa[2] = 0x0; bss_param->sa[3] = 0x0; bss_param->sa[4] = 0x0; bss_param->sa[5] = 0x0;
	bss_param->bssid[0] = 0x58; bss_param->bssid[1] = 0xef; bss_param->bssid[2] = 0x68; bss_param->bssid[3] = 0x24; bss_param->bssid[4] = 0xe1; bss_param->bssid[5] = 0xf3;
	bss_param->beacon_period = 0x64;
	bss_param->dtim_period = 0x0;
	bss_param->supp_rates[0] = 0xc; bss_param->supp_rates[1] = 0x82; bss_param->supp_rates[2] = 0x84; bss_param->supp_rates[3] = 0x8b ; bss_param->supp_rates[4] = 0x96;
	bss_param->supp_rates[5] = 0x12; bss_param->supp_rates[6] = 0x24; bss_param->supp_rates[7] = 0x48; bss_param->supp_rates[8] = 0x6c; bss_param->supp_rates[9] = 0xc;
	bss_param->supp_rates[10] = 0x18; bss_param->supp_rates[11] = 0x30; bss_param->supp_rates[12] = 0x60;
	bss_param->wmm_cap = 0x1;
	bss_param->uapsd_cap = 0x0;
	bss_param->ht_capable = 0x1;
	bss_param->rsn_found = 0x0;
	bss_param->rsn_grp_policy = 0x0;
	bss_param->mode_802_11i = 0x0;
...
static void handle_connect_timeout(struct work_struct *work)
{
	...
	wid.type = WID_CHAR;
	wid.val = (int8_t *)&dummy_reason_code;
	wid.size = sizeof(char);
				...
				struct cfg80211_crypto_settings *crypto)
{
	...
	param->ch = ieee80211_mhz2ieee(bss->channel->ic_freq, bss->channel->ic_flags);
...
static void get_periodic_rssi(unsigned long arg)
{
	...
	setting.it_value.tv_sec = 5;
	setting.it_value.tv_nsec = 0;
	timer_settime (vif->periodic_rssi, 0, &setting, 0);
}
