...
void init_clocks()
{
	//edlcd board has no 32768 crystal assembled
    //init_rtc();
    /* 
    ...
    /* MMC2 */
    out32(AM335X_CM_PER_MMC2_CLKCTRL, CM_CLOCK_ENABLE);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/startup/boards/ti-am335x/init_clocks.c $ $Rev: 809065 $")
#endif
